...
def get_network(tokens_capacity, embedding_min_frequency, embedding_max_frequency, embedding_dims):
    ...
    x = layers.Dense(256, name="dense02")(x)
    x = layers.Dense(128, name="dense03")(x)
    x = layers.Dense(256, name="dense04")(x)
    x = layers.Dense(256, name="dense05")(x)
    x = layers.Dense(512, name="dense06")(x)
    x = layers.Dense(1024, name="dense07")(x)
    x = layers.Dense(2048, kernel_initializer="zeros", name="last_dense")(x)
